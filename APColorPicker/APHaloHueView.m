...
#import "APHaloHueView.h"

#define MIN_ANGLE 0
#define MAX_ANGLE (M_PI*2)

@interface APHaloHueView ()
...
- (void)setDelegate:(id<APHaloHueViewDelegate>)delegate
{
    _delegate = delegate;
...
//    CGContextDrawPath(context, kCGPathEOFill);
    ...
    //// Oval Drawing
    UIBezierPath* ovalPath = [UIBezierPath bezierPathWithArcCenter:knobCenter radius:12 startAngle:0 endAngle:2*M_PI clockwise:YES];
    CGContextSaveGState(context);
    CGContextSetShadowWithColor(context, shadow.shadowOffset, shadow.shadowBlurRadius, [shadow.shadowColor CGColor]);
    [[UIColor colorWithHue:[self hue] saturation:1 brightness:1 alpha:1] setFill];
    [ovalPath fill];
    CGContextRestoreGState(context);
